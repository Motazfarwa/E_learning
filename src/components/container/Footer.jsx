      ...
      <div className=" grid md:grid-cols-4 sm:grid-cols-3 xs:grid-cols-2 grid-cols-1 place-items-start gap-8 text-white">
        <div>
          ...
          <p className=" text-sm leading-7">
            ...
            voluptatem earum! Odit ullam necessitatibus laboriosam, hic
          </p>
        </div>
        <div>
        ...
        <div>
          ...
          <div className=" text-sm mb-4">masudskilllearning@gamil.com </div>
          <div className=" text-sm">+8801722539108</div>
